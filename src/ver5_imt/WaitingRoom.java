...
public class WaitingRoom extends JFrame {
	...
	WaitingRoom mWaitingRoomContext = this; 
	...
	public WaitingRoom(ClientBack mContext) {
	...
	private void initData() {
		...
		loomlistIg = new JLabel(new ImageIcon("image/대기/룸리스트.png"));
	(chattingRoom= new ChattingRoom(mContext)).setVisible(false);
	chattingRoom.setTitle(" 메모장 - [" +  id + "]" );
		userList = new JList<>();
